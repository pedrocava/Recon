...
rowunlisted <- setNames(unlist(listrow, use.names=F),rep(names(listrow), lengths(listrow)))
colunlisted <- setNames(unlist(listcol, use.names=F),rep(names(listcol), lengths(listcol)))
