...
cournot_2 = function(q0_1 = 0, c1 = 1, c1_2 = 0,
  ...
  profit1 = quote((p_0 + a*q + b * q^2)*(c1+c1_2*(2*q1)) -1*(q0_1 + c1 * q1 + c1_2 * q1 ** 2)) #each firm's profit curve
  profit2 = quote((p_0 + a*q + b * q^2)*(c2+c2_2*(2*q2)) -1*(q0_2 + c2 * q2 + c2_2 * q2 ** 2))
